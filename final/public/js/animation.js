...
var colors=[[1.0, 0.2, 0.5],[0.95, 0.1, 0.5],[0.90, 0.05, 0.5],[0.85, 0, 0.5],[0.03, 1, 1]];
// var colors=[[1.0, 0.2, 0.5],[0.95, 0.1, 0.5],[0.90, 0.05, 0.5],[0.85, 0, 0.5],[0.80, 0, 0.5]];
var sizes=[150,100,50,38,25];
var audioLoader;
var textures=["img/textures/oil drop.png","img/textures/light_1.png"];
...
$.ajax({
	...
	success: function(data) {
		console.log("data from /wish/get");
...
function init(data) {
  ...
  function createSound(filename) {
      ...
      //TODO: CHECK SOUDN FILE LOCATION
  ...
  //TODO: SOUND FILENAME USES _ID

    data.forEach(function(wish){
	    camera.add(createSound(wish._id));
    });
